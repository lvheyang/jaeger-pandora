...
// JaegerSpanReader is a struct which holds pandora span reader properties
type JaegerSpanReader struct {
	apiToken                string
	apiURL                  string
	logger                  hclog.Logger
	sourceFn                sourceFn
...
// NewLogzioSpanReader creates a new pandora span reader
func NewLogzioSpanReader(config PandoraConfig, logger hclog.Logger) *JaegerSpanReader {
...
func (reader *JaegerSpanReader) GetTrace(ctx context.Context, traceID model.TraceID) (*model.Trace, error) {
...
func (reader *JaegerSpanReader) GetServices(ctx context.Context) ([]string, error) {
...
func (reader *JaegerSpanReader) GetOperations(ctx context.Context, service string) ([]string, error) {
...
func (reader *JaegerSpanReader) FindTraces(ctx context.Context, query *spanstore.TraceQueryParameters) ([]*model.Trace, error) {
...
func (reader *JaegerSpanReader) FindTraceIDs(ctx context.Context, query *spanstore.TraceQueryParameters) ([]model.TraceID, error) {
...
func (reader *JaegerSpanReader) getHTTPRequest(requestBody string) (*http.Request, error) {
...
func (reader *JaegerSpanReader) getHTTPResponseBytes(request *http.Request) ([]byte, error) {
	...
	reader.logger.Trace(fmt.Sprintf("got response from pandora: %s", string(responseBytes)))
...
func (reader *JaegerSpanReader) getSearchResult(requestBody string) (*elastic.SearchResult, error) {
...
func (reader *JaegerSpanReader) getMultiSearchResult(requestBody string) (elastic.MultiSearchResult, error) {
	if reader.apiToken == "" {
...
func (*JaegerSpanReader) GetDependencies(endTs time.Time, lookback time.Duration) ([]model.DependencyLink, error) {
	return nil, nil
}
